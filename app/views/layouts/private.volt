        ...
        <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>{{ link_to('tips', 'List Tips') }}</li>
                        <li>{{ link_to('tips/create', 'Create Tip') }}</li>
                    </ul>
                </li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                   aria-expanded="false">Breeds<span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li>{{ link_to('breeds', 'List Breeds') }}</li>
                    <li>{{ link_to('breeds/create', 'Create Breed') }}</li>
                </ul>
            </li>
            </ul>
